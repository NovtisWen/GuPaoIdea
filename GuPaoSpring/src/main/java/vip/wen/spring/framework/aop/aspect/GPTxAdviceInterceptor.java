 ...
 * 事务执行
 */
public class GPTxAdviceInterceptor extends GPAbstractAspectAdvice implements GPMethodInterceptor {

    private GPJointPoint jointPoint;

    public GPTxAdviceInterceptor(Method aspectMethod, Object aspectTarget) {
